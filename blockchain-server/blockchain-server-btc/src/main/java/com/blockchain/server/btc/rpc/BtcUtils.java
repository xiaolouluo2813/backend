...
public class BtcUtils {
    ...
    public BigDecimal getBalance(String account) throws Exception {
        ...
        try {
            if (!StringUtils.isEmpty(account)) {
                balance = client.getClient().invoke("getbalance", new Object[]{account}, BigDecimal.class);
            } else {
                balance = client.getClient().invoke("getbalance", new Object[]{}, BigDecimal.class);
            }
            return balance;
        } catch (Throwable e) {
    ...
    public String sendtoaddress(String toAddress, double amount) throws Exception {
        try {
            ...
            throw new BtcWalletException(BtcWalletEnums.SENDTOADDRESS_ERROR);
        }
    }
